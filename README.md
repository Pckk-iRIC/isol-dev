...
開発中のソルバーのテンプレ生成、テスト実行、配布用ビルドまでをまとめて行う。

## すぐ使う (最短手順)
1. インストール (GitHub から直接)
```
pip install git+https://github.com/Pckk-iRIC/isol-dev.git
```
...
- 開発用 (編集モード)
```
git clone https://github.com/Pckk-iRIC/isol-dev.git
cd isol-dev
pip install -e .
```
...
## リリースノート
- 変更点は `CHANGELOG.md` で管理する。
- まとまったタイミングで GitHub Releases に転記する。
